    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('agents.create_task', $agent->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="row g-2">
                        <div class="col mb-3">
                            <label for="nameBasic" class="form-label">Mijozlar</label>
                    ...
                    <div class="row g-2">
                        <div class="col mb-3">
                            ...
                            <input type="tel" id="phone" class="form-control" name="phone" value="{{ $agent->phone }}" pattern="[0-9]{9}" maxlength="9" />
                        </div>
                    </div>
